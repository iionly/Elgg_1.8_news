...
function news_init() {
	...
	elgg_register_event_handler('publish_news', 'news', 'object_notifications');
	...
	elgg_register_widget_type("news_in_groups", elgg_echo("news:news_in_groups:title"), elgg_echo("news:news_in_groups:description"), "profile,index,dashboard", true);
	...
	if (elgg_is_active_plugin('widget_manager')) {
		...
		elgg_register_widget_type('index_news', elgg_echo("news:news"), elgg_echo('news:widget:description'), "index");

		//add groups widget for Widget Manager plugin
		elgg_register_widget_type('groups_news', elgg_echo("news:news"), elgg_echo('news:widget:description'), "groups");
...
function news_notify_message($hook, $type, $message, $params) {
	...
	if (elgg_instanceof($entity, 'object', 'news')) {
		...
		$excerpt = $entity->excerpt ? $entity->excerpt : $entity->description;
